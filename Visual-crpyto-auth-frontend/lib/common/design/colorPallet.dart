...
class CustomTheme {
  static ThemeData lightTheme = ThemeData.light().copyWith(
    extensions: <ThemeExtension<dynamic>>{
      const AppColors(
        c1: Color.fromRGBO(62, 0, 172, 1), // Black
        c2: Color.fromRGBO(82, 0, 229, 1), // A shade of dark gray
        c3: Color.fromRGBO(67, 14, 187, 1), // A slightly lighter shade of dark gray
        c4: Color.fromRGBO(240, 80, 30, 1), // A shade of medium gray
        c5: Color.fromRGBO(25, 28, 32, 1), // A slightly lighter shade of medium gray
        c6: Color.fromRGBO(204, 204, 204, 1), // A shade of light gray
        c7: Color.fromRGBO(217, 217, 217, 1), // A slightly darker shade of light gray
        c8: Color.fromRGBO(242, 242, 242, 1), // Another shade of light gray
        c9: Color.fromRGBO(166, 166, 166, 0.9), // An off-white color with a bit of transparency
        c10: Color.fromRGBO(166, 166, 166, 1), // White with opacity
        c11: Color.fromRGBO(230, 230, 230, 1), // White with medium opacity
        c12: Color.fromRGBO(255, 255, 255, 1), // White
      ),
    },
  );
